...
for (i in 1:M) {
  ...
  ci_normal_result = np_pred_CI(np_fit, exdat = x_grid, B = 50, type_CI = "standard")
...
for (i in 1:M) {
  ...
  # Compute CI using function first for normal CI
  ci_normal_result = np_pred_CI(np_fit, exdat = x_grid, B = 50, type_CI = "quantiles")
...
cat("the mean coverage of the normal CI is :",mean(coverage.normal),"and ","the mean coverage of the quantile CI is :",mean(coverage.quantile))
```
```{r} 
#n = 200
set.seed(1234)
...
for (i in 1:M) {
  ...
  # Compute CI using function first for normal CI
  ci_normal_result2 = np_pred_CI(np_fit, exdat = x_grid, B = 50, type_CI = "quantiles")
...
cat("the mean coverage of the normal CI is :",mean(coverage.normal2),"and ","the mean coverage of the quantile CI is :",mean(coverage.quantile2))
...
for (i in 1:M) {
  ...
  # Compute CI using function first for normal CI
  ci_normal_result3 = np_pred_CI(np_fit, exdat = x_grid, B = 50, type_CI = "standard")
...
for (i in 1:M) {
  ...
  # Compute CI using function first for normal CI
  ci_normal_result3 = np_pred_CI(np_fit, exdat = x_grid, B = 50, type_CI = "quantiles")
...
```
 conclusion: falta
 when you increase the number in the n the covarege...
